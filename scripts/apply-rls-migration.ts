/**
 * Apply RLS fix migration to messages and conversations tables
 */
...
async function applyMigration() {
  console.log('🔧 Application de la migration fix_messages_rls.sql...\n');

  try {
    // Lire le fichier de migration
    const migrationPath = resolve(
      process.cwd(),
      'supabase/migrations/fix_messages_rls.sql'
    );
    ...
    console.log('\n💡 Testez maintenant: Ouvrez /chat et créez une conversation');
